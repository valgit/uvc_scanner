...
@class UVCCameraView;
@class UVCCamera;
@interface UVCCameraWindowController : NSWindowController <NSWindowDelegate> {
	IBOutlet UVCCameraView					*cameraView;
	UVCCamera								*camera;
	
	IBOutlet NSTextField					*fpsTF;
	IBOutlet NSTextField					*kbpsTF;
	
	NSTimer									*refreshTimer;
	
	IBOutlet NSPopUpButton					*configSelectButton;
